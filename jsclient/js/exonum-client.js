...
},{"./hash":7,"buffer":4,"inherits":6}],10:[function(require,module,exports){
(function (Buffer){
/*
...
},{"./hash":7,"buffer":4,"inherits":6}],11:[function(require,module,exports){
(function (Buffer){
/**
...
},{"./hash":7,"./sha256":12,"buffer":4,"inherits":6}],12:[function(require,module,exports){
(function (Buffer){
/**
 * A JavaScript implementation of the Secure Hash Algorithm, SHA-256, as defined
 * in FIPS 180-2
...
},{"./hash":7,"buffer":4,"inherits":6}],13:[function(require,module,exports){
(function (Buffer){
var inherits = require('inherits')
...
},{"./hash":7,"./sha512":14,"buffer":4,"inherits":6}],14:[function(require,module,exports){
(function (Buffer){
var inherits = require('inherits')
var Hash = require('./hash')
...
},{"./hash":7,"buffer":4,"inherits":6}],15:[function(require,module,exports){
(function(nacl) {
'use strict';
...
},{"crypto":3}],16:[function(require,module,exports){
'use strict';
...
},{"../crypto":20,"../helpers":21,"../types/generic":24,"../types/message":26,"../types/primitive":27,"../types/validate":29}],17:[function(require,module,exports){
'use strict';
...
},{"./block":16,"./merkle":19,"./merkle-patricia":18}],18:[function(require,module,exports){
'use strict';
...
function merklePatriciaProof(rootHash, proofNode, key, type) {
  ...
  function getHash(element) {
    if (typeof element === 'string') {
      ...
      return (0, _crypto.hash)(element);
    } else if ((0, _helpers.isObject)(element)) {
      return (0, _crypto.hash)(element, type);
    }
  }
  ...
  function recursive(node, keyPrefix) {
    ...
    for (var keySuffix in node) {
      ...
      if (fullKey.length === MERKLE_PATRICIA_KEY_LENGTH * 8) {
        if (typeof nodeValue === 'string') {
          ...
          branchType = 'hash';
        } else if ((0, _helpers.isObject)(nodeValue)) {
    ...
    if (left.type === 'hash' && right.type === 'hash' && fullKey.length < MERKLE_PATRICIA_KEY_LENGTH * 8) {
...
},{"../crypto":20,"../helpers":21,"../types/convert":23,"../types/generic":24,"../types/primitive":27,"../types/validate":29}],19:[function(require,module,exports){
'use strict';
...
},{"../crypto":20,"../helpers":21,"../types/convert":23,"../types/generic":24,"../types/validate":29,"big-integer":2}],20:[function(require,module,exports){
'use strict';
...
/**
 * Return a key pair with public key corresponding to the given 64-byte secret key
 * @param {string} secretKey
 * @return {Object}
 *  publicKey {string}
 *  secretKey {string}
...
function fromSecretKey(secretKey) {
  var pair = _tweetnacl2.default.sign.keyPair.fromSecretKey(convert.hexadecimalToUint8Array(secretKey));
  var publicKey = convert.uint8ArrayToHexadecimal(pair.publicKey);
...
},{"../types/convert":23,"../types/generic":24,"../types/message":26,"../types/validate":29,"big-integer":2,"sha.js":8,"tweetnacl":15}],21:[function(require,module,exports){
'use strict';
...
},{"./blockchain":17,"./crypto":20,"./types":25}],23:[function(require,module,exports){
'use strict';
...
},{"../types/validate":29}],24:[function(require,module,exports){
'use strict';
...
},{"../crypto":20,"./serialization":28}],25:[function(require,module,exports){
'use strict';
...
},{"./convert":23,"./generic":24,"./message":26,"./primitive":27}],26:[function(require,module,exports){
'use strict';
...
},{"../crypto":20,"./generic":24,"./primitive":27,"./serialization":28}],27:[function(require,module,exports){
'use strict';
 ...
 * @returns {Array}
 */
function String(string, buffer, from, to, relativeFromIndex) {
  if (typeof string !== 'string') {
...
},{"./validate":29,"big-integer":2}],28:[function(require,module,exports){
'use strict';
...
function serialize(buffer, shift, data, type) {
  function isFixed(fields) {
    for (var fieldName in fields) {
      ...
      } else if (fields[fieldName].type === _primitive.String || fields[fieldName].type === _primitive.FixedBuffer) {
        return false;
      }
    }
    return true;
  ...
  for (var fieldName in type.fields) {
    ...
    if ((0, _generic.isInstanceofOfNewType)(fieldType.type)) {
      if (isFixed(fieldType.type.fields)) {
        ...
        (0, _primitive.Uint32)(end - shift, buffer, from, from + 4);
...
},{"./generic":24,"./primitive":27}],29:[function(require,module,exports){
'use strict';
